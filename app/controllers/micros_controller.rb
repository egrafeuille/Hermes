class MicrosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @micro.save
        format.html { redirect_to @micro, notice: 'Micro cycle was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @micro.update(micro_params)
        format.html { redirect_to @micro, notice: 'Micro cycle was successfully updated.' }
  ...
  def destroy
    @micro.destroy
    respond_to do |format|
      format.html { redirect_to micros_url, notice: 'Micro cycle was successfully destroyed.' }
  ...
  private
    ...
    def micro_params
      params.require(:micro).permit(:meso_id, :name, :notes, :volume)
    end
end
