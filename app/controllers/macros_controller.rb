class MacrosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @macro.save
        format.html { redirect_to @macro, notice: 'Macro cycle was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @macro.update(macro_params)
        format.html { redirect_to @macro, notice: 'Macro cycle was successfully updated.' }
  ...
  def destroy
    @macro.destroy
    respond_to do |format|
      format.html { redirect_to macros_url, notice: 'Macro cycle was successfully destroyed.' }
  ...
  private
    ...
    def macro_params
      params.require(:macro).permit(:name, :notes, :startDate, :endDate, :volume)
    end
end
