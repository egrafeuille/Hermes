...
class CyclesControllerTest < ActionController::TestCase
  ...
  test "should create cycle" do
    assert_difference('Cycle.count') do
      post :create, cycle: { end_date: @cycle.end_date, name: @cycle.name, notes: @cycle.notes, start_date: @cycle.start_date, volume: @cycle.volume }
    end
  ...
  test "should update cycle" do
    patch :update, id: @cycle, cycle: { end_date: @cycle.end_date, name: @cycle.name, notes: @cycle.notes, start_date: @cycle.start_date, volume: @cycle.volume }
    assert_redirected_to cycle_path(assigns(:cycle))
  end
